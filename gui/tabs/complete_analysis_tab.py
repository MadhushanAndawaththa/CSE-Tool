...
from gui.styles import (
    CARD_STYLE, TEXT_SECONDARY, TEXT_SECONDARY_DARK,
    SUCCESS, WARNING, DANGER, TEXT, _D_TEXT, _D_SURFACE, _D_BORDER,
    get_info_card_style
)
...
class CompleteAnalysisTab(QWidget):
    ...
    def init_ui(self):
        ...
        price_hint = QLabel("Enter historical closing prices, one per line (oldest first).\n"
                            "Need at least 35 prices for full analysis.")
        price_hint.setWordWrap(True)
        price_hint.setStyleSheet(f"color: {TEXT_SECONDARY}; font-size: 11px;")
        tech_layout.addWidget(price_hint)
        ...
        score_title.setStyleSheet(f"font-size: 10px; font-weight: bold; color: {TEXT_SECONDARY}; letter-spacing: 1px;")
        ...
        s_title = QLabel("✅ Key Strengths")
        s_title.setStyleSheet(f"color: {SUCCESS}; font-weight: bold; font-size: 13px;")
        ...
        c_title = QLabel("⚠ Key Concerns")
        c_title.setStyleSheet(f"color: {DANGER}; font-weight: bold; font-size: 13px;")
        ...
        act_title = QLabel("📋 Action Items")
        act_title.setStyleSheet(f"font-weight: bold; font-size: 13px;")
